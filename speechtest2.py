...
try:
    print("Wit.ai thinks you said " + r.recognize_wit(audio, key='AXIII6X7MAX2KW6FD27UFMT3VVQXM6WO'))
except sr.UnknownValueError:
    print("Wit.ai could not understand audio")
except sr.RequestError as e:
    print("Could not request results from Wit.ai service; {0}".format(e))

if re.compile(r'\bsous chef\b', flags=re.IGNORECASE).search(r.recognize_wit(audio, key='AXIII6X7MAX2KW6FD27UFMT3VVQXM6WO')):
    print 'yes'
else:
    print 'no'
